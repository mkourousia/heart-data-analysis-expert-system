...
(bind ?response (read))
(if (= ?response 1) then
(open "C:/Users/mariak/heart-data-analysis-expert-system/clips/input-training-set.clp" inputfile "r")
(printout t "Training set loaded" crlf crlf)
else
(open "C:/Users/mariak/heart-data-analysis-expert-system/clips/input-test-set.clp" inputfile "r")
